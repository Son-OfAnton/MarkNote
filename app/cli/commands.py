...
def export_to_pdf(title: Optional[str], output_path: Optional[str],
    ...
    try:
        ...
        if title:
            ...
            # No title provided, so export all notes
            if not output_path:
...
@click.argument("titles", nargs=-1, required=True)
@click.option("--output-dir", "-o", required=True, help="Directory to save the exported PDFs.")
...
@click.argument("titles", nargs=-1, required=True)
@click.option("--output-dir", "-o", required=True, help="Directory to save the exported HTML files.")
@click.option("--category", "-c", help="Category of the notes.")
@click.option("--source-dir", "-s", help="Custom directory to look for notes.")
@click.option("--custom-css", help="Path to a custom CSS file for styling the HTML files.")
...
@click.option("--category", "-c", help="Category of the notes to include.")
@click.option("--source-dir", "-s", help="Custom directory to look for notes.")
...
def create_static_site(output_dir: str, category: Optional[str],
    ...
    try:
        ...
        site_info = (
            ...
            f"Main page: [cyan]{index_path}[/cyan]\n\n"
            "To view your site:\n"
            f"1. Open [cyan]{index_path}[/cyan] in your web browser\n"
